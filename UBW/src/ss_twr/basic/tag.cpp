...
/*
1.5 Jednostki czasu DW3000
Wszystkie timestampy DW są w jednostkach czasu DW (DTU).

1 DTU ≈ 15.65 picosekund (dokładnie 1/(128×499.2 MHz))
1 UUS (UWB microsecond) = 65536 DTU ≈ 1.0256 µs
Timestampy chipa są 40-bitowe (przepełnienie co ~17.2 s)
...
/*
dwt_config_t parametry:
------------------------
channel number - 5 lub 9:
 kanał 5 - 6240–6739 MHz (najczęściej używany, bo ma najlepszy zasięg i jest prawie wszędzie legalny)
 kanał 9 - 6739–7238 MHz (gorszy zasięg ale teoretycznie wyższa dokładność bo krótsza fala, może być usefull jak kanał 5 zatłocozny bd)
 stąd nazwa UWB - Ultra Wide Band, bo zajmuje szerokie pasmo częstotliwości
------------------------
długość preambuły -
*/
...
// this was changed from 240 to 500
#define POLL_TX_TO_RESP_RX_DLY_UUS 500

// this was changed from 400 to 800
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            ...
            if (frame_len <= sizeof(rx_buffer))
            {
                ...
                if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0)
                {
                    ...
                    /* Display computed distance on Serial. */
